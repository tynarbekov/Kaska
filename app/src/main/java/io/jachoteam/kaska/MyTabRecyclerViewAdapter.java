...
import io.jachoteam.kaska.TabFragment.OnListFragmentInteractionListener;
...
public class MyTabRecyclerViewAdapter extends RecyclerView.Adapter<MyTabRecyclerViewAdapter.ViewHolder> {
    ...
    public MyTabRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
